...
/* Definitions for isrSem */
osSemaphoreId_t isrSemHandle;
const osSemaphoreAttr_t isrSem_attributes = {
  .name = "isrSem"
};
/* USER CODE BEGIN PV */
...
void StartHandlerTask(void *argument);
...
int main(void)
{
  ...
  /* creation of isrSem */
  isrSemHandle = osSemaphoreNew(1, 0, &isrSem_attributes);
  ...
  handlerTaskHandle = osThreadNew(StartHandlerTask, NULL, &handlerTask_attributes);
